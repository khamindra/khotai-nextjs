		...
		<header className='border-b border-b-gray-400 py-5'>
			<Container className='flex items-center justify-between gap-7 text-lightColor'>
				...
				<div className='w-auto md:w-1/3 flex items-center justify-center gap-2.5'>
					<MobileMenu />
					<Logo className='text-blue-600'>Khotai</Logo>
				</div>
					...
					<ClerkLoaded>
						<SignedIn>
							<Link
								...
								<span className='absolute -top-1 -right-1 bg-darkColor text-white h-3.5 w-3.5 rounded-full text-xs font-semibold flex justify-center items-center'>
									0
								</span>
							</Link>
							<UserButton />
